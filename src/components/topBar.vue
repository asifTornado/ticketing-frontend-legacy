...
<div class="text-4xl text-black  p-3 font-bold ml-10 hover:cursor-pointer" v-if="this.$route.path.split('/')[1] == 'ticketing'" style="text-shadow: 1px 1px black;" @click="home()">  Help Desk</div>
<div class="text-4xl text-black  p-3 font-bold ml-10 hover:cursor-pointer" v-if="this.$route.path.split('/')[1] == 'travel'" style="text-shadow: 1px 1px black;" @click="home()">Travel Management</div>

</div>

<div class="text-4xl font-bold flex flex-row justify-end    w-[370px] items-center" v-if="this.authStore.getUser">
  <template v-if="this.authStore.getUser.userType == 'leader'">Ticket Manager</template>
  <template v-else-if="this.authStore.getUser.userType == 'normal'">Normal User</template>
  <template v-else-if="this.authStore.getUser.userType == 'support'">Support User</template>
  <template v-else-if="this.authStore.getUser.userType == 'admin'">Admin</template>


</div>

<notifications v-if="this.authStore.getUser && this.$route.path.split('/')[1] == 'ticketing'" class=" ml-80"/>
...
<div class="flex flex-row mr-5 ">
  ...
  <div  v-if="this.authStore.getToken != null && this.$route.path.split('/')[1] == 'ticketing'" class="noprint text-white hover:cursor-pointer mr-2 text-sm flex flex-row justify-between items-center align-middle  " @click="this.$router.push('/ticketing/blog/knowledge')"><div class=" w-40 p-2 border  hover:shadow-md    border-solid text-black border-black" style="transition: 0.2s;" onmouseover="this.style.boxShadow = '3px 3px 0px black';"
    ...
    <div class="w-full " v-if="this.$route.path.split('/')[1] == 'ticketing'"  id="" @click="showPopUp" >
