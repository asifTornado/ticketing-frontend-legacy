<template>
   ...
   <div class=" flex flex-row   text-lg  h-[92vh] w-full  bg-[rgb(248,248,248)] ml-[30px]  " id="app"  >
    ...
    <div class="flex flex-col h-[92vh] customborder absolute  bg-white ml-[20px]     py-10 " style="z-index: 9999999999999999999999999999999999;" id="sidePanel" v-if="this.mainStore.getSidePanelCheck">
...
<ClearButton/>
    ...
    <table class="w-full text-md text-left text-gray-500 dark:text-gray-400 ">
        ...
        <tbody>
            <tr  :class="setRowColor(ticket.priority.priority)" v-for="(ticket, ticketCounter) in sortedTickets" :key="ticketCounter">
