<template >
   ...
   <template v-if="tickets">   <div class="mb-4 p-3 font-bold flex flex-col hover:cursor-pointer hover:bg-gray-300" v-for="(ticket, ticketCounter) in tickets" @click="selectTicket(ticket._id)" >
      ...
      <template v-else>
          ...
          <div class="p-3 font-bold bg-gray-200 absolute right-2 bottom-2 text-black  flex flex-row justify-end hover:cursor-pointer hover:bg-black hover:text-white" @click="this.searchCheck = false">Cancel</div>
